...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-03-2018 a las 22:58:06
...
('root', '[{\"db\":\"empresa\",\"table\":\"formularios\"},{\"db\":\"empresa\",\"table\":\"empleado\"},{\"db\":\"usuarios\",\"table\":\"cyb_users\"},{\"db\":\"mmv\",\"table\":\"mmv001\"},{\"db\":\"empresa\",\"table\":\"registros\"},{\"db\":\"empresa\",\"table\":\"usuarios\"},{\"db\":\"Empresa\",\"table\":\"usuarios\"}]');
...
('root', 'empresa', 'empleado', '{\"CREATE_TIME\":\"2018-03-26 00:20:52\"}', '2018-03-26 08:26:41'),
('root', 'empresa', 'formularios', '{\"sorted_col\":\"`formularios`.`user_id`  DESC\"}', '2018-03-29 07:59:12');
...
('root', '2018-03-25 02:54:09', '{\"Server\\/hide_db\":\"\",\"Server\\/only_db\":\"\",\"lang\":\"es\",\"collation_connection\":\"utf8mb4_unicode_ci\",\"ThemeDefault\":\"pmahomme\"}');
